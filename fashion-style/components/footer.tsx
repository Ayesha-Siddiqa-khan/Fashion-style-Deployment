        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-neutral-400 text-sm leading-relaxed">
              Curating the finest fashion for the modern individual. Quality, style, and elegance in every piece.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.shop.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-neutral-400 hover:text-amber-400 text-sm transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
